...
/**
 * The query class for article links providing the most common named scopes.
 *
 * @author Pascal Mueller, AS infotrack AG
 * @link http://www.asinfotrack.ch
 * @license AS infotrack AG license / MIT, see provided license file
 */
class ArticleLinkQuery extends \yii\db\ActiveQuery
{
	 ...
	 * @return \asinfotrack\yii2\article\models\query\ArticleLinkQuery $this self for chaining
	 */
